...
import { updatePost, uploadImage, Post } from '@/lib/api';
import { useUser } from '@/context/UserContext';

export default function EditForm({ id, initialPost }: { id: string, initialPost: Post }) {
  ...
  const [currentImageUrl, setCurrentImageUrl] = useState<string | null>(initialPost.image_url || null);
